...
# Persistent external MCP auto-approvals are intentionally not generated by
# this convenience script. Add explicit [[mcp.trusted_servers]] entries as an
# administrator when a concrete server identity and individual tools have been
# reviewed. See admin_config.example.toml.
"@
