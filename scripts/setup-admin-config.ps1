...
# External stdio MCP servers are intentionally not generated by this convenience
# script. Every such server must be defined individually as a concrete
# [[mcp.trusted_servers]] launch profile by an administrator. HTTP MCPs need a
# trusted-server entry only for explicit instruction trust or permanent pinned
# tool auto-approvals. See admin_config.example.toml.
"@
