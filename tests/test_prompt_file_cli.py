...
def test_prompt_file_runs_exactly_one_prompt_without_os_access(tmp_path, monkeypatch) -> None:
...
def test_prompt_file_can_be_combined_with_context_and_output(tmp_path, monkeypatch) -> None:
    ...
    assert captured["prompts"] == ["Review it."]
